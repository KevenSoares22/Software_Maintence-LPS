...
import View.FrCreateMainteceInfo;

import javax.swing.*;
import java.awt.event.ActionEvent;
import java.awt.event.ActionListener;

public class FrCreateMainteceInfoController {
    private FrCreateMainteceInfo view;

    public FrCreateMainteceInfoController(FrCreateMainteceInfo view) {
        this.view = view;
        initController();
    }
    ...
    private void handleCriarButton() {
        ...
        if (campo1.isEmpty() || campo2.isEmpty() || campo3.isEmpty() || campo4.isEmpty() || campo6.isEmpty()) {
        ...
        JOptionPane.showMessageDialog(view, "Relatório criado com sucesso!", "Sucesso", JOptionPane.INFORMATION_MESSAGE);
    }
}
