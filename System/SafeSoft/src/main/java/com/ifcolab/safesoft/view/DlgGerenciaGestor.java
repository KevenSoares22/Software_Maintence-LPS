...
public class DlgGerenciaTecnico extends javax.swing.JDialog {
    ...
    public DlgGerenciaTecnico(java.awt.Frame parent, boolean modal) {
        ...
        grdTecnicoes.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                grdTecnicoesMouseClicked(evt);
            }
        });
        
        controller.atualizarTabela(grdTecnicoes);
    }
    ...
    private Object getObjetoSelecionadoNaGrid() {
        int rowCliked = grdTecnicoes.getSelectedRow();
        Object obj = null;
        if (rowCliked >= 0) {
            obj = grdTecnicoes.getModel().getValueAt(rowCliked, -1);
        }
        return obj;
    }
    ...
    private void initComponents() {
        ...
        grdTecnicoes = new com.ifcolab.safesoft.components.CustomTable();
        ...
        grdTecnicoes.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {},
                {},
                {},
        ...
        tmTecnicoes.setViewportView(grdTecnicoes);
        ...
        lblSubtituloGerenciaTecnicoes.setText("Adicione, edite ou remova informações dos tecnicoes, incluindo especialidades e dados de contato.");
        getContentPane().add(lblSubtituloGerenciaTecnicoes);
        lblSubtituloGerenciaTecnicoes.setBounds(30, 40, 780, 17);
        ...
        lblTitleGerenciaTecnicoes.setText("Gerenciar Tecnicoes");
    ...
    private void grdTecnicoesMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_grdTecnicoesMouseClicked
        if (evt.getClickCount() == 2) {
            btnEditarActionPerformed(null);
        }
    }//GEN-LAST:event_grdTecnicoesMouseClicked
    ...
    private com.ifcolab.safesoft.components.CustomTable grdTecnicoes;
